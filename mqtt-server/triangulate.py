...
if __name__ == '__main__':
    while True:
        ...
        while node_1_rssi == None or node_2_rssi == None or node_3_rssi == None:
            msg = subscribe.simple('@msg/taist2020/device/#', hostname='mqtt.netpie.io', port=1883, client_id=CLIENT_ID, auth={'username':NETPIE_TOKEN, 'password':None}, keepalive=10)
        ...
        #send data using https, post method to heroku server
        coordinate = triangulate(node_1_rssi,node_2_rssi,node_3_rssi)
        crl = pycurl.Curl()
        crl.setopt(pycurl.CAINFO, certifi.where())
        crl.setopt(crl.URL, "https://iot-positioning.herokuapp.com/input")
